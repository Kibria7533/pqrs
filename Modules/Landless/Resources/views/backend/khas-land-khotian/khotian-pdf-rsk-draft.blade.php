                    ...
                    <table class="htable" border="0"  style="margin-top: 2px">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border:1px; padding-bottom: 15px;  font-size: 16px;">জে, এল,
                                <span style="font-family: muktinarrow">নংঃ</span>  <?php echo substr($header_info['dglr_code'], -3); ?></td>
                    ...
                    <table class="table" border="0" cellpadding="0" cellspacing="0" class="pp" id="table_<?= $i ?>"
                        ...
                        <tr style="height: 1.2cm">
                            ...
                            <td style="font-size: 15px; text-align: right;vertical-align:middle;<?= $border_right ?> <?= $border_top ?> border-bottom:1px solid;padding-right:5px;"
                                colspan="7">
                        <span style="font-style: italic;font-size: 12px;text-align: center; width: 60%; float: left; padding-top: 4px;">
                            <i style="margin-top: 8px; position: absolute;">পরিবার পরিকল্পনা গ্রহণ করুন</i>
                            <img style="width: 100px;position: absolute;margin-top: -12px;margin-left: 27px;" src="http://training.land.gov.bd/rsk/webroot/img/map_seal.png"/>
                        </span>
                        ...
                        <tr>
                            ...
                            <td colspan="4" rowspan="3" style="vertical-align: middle">
                                <?php if(false): ?>
                                <img src="<?php echo '/storage/qr/'. $qr_code; ?>" width="140" height="140" />
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
