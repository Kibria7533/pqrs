...
@section('full_page_content')
    ...
    <div class="bitac-login-area">
        <div class="login-area text-center">
            <div class="row">
                <div class="col-sm-12 pt-5" style="margin-top: 110px;">
                    <h4 class="pt-4 pb-4"
                        style="color: #fff; margin-bottom: 0px; padding-bottom: 0 !important;">{{__('generic.lrms_noakhali')}}
                    </h4>
                </div>
    ...
    @push('css')
        <style>
            ...
            .bitac-login-area {
                ...
                overflow: hidden;
                background: #673ab7;
                background: linear-gradient(0deg, #3a3bb7 0%, #03e3f4 100%);
            }
