            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between custom-header custom-bg-gradient-info">
                        <h3 class="card-title font-weight-bold">{{ __('generic.user_type_edit') }}</h3>
                        ...
                        <form
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-form-control" name="title" id="title"
                                           value="{{!empty($userType->title)?$userType->title: old('title')}}"
                                           placeholder="Title" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="default_role_id">{{ __('generic.default_role') }} <span style="color:red">*</span></label>
                                ...
                                <div class="col-sm-12 text-right">
                                    <button type="submit" class="btn btn-success">{{ __('generic.update')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
