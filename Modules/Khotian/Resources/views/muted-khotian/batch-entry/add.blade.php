                                    ...
                                    <div class="card">
                                        <div class="card-header custom-header-bg" id="heading-2" style="height: 56px">
                                            <h3 class="card-title font-weight-bold">
                                                <i class="fas fa-plus-square"></i> খতিয়ান ব্যাচ-এন্ট্রি
                                            </h3>
                                        ...
                                        <div id="collapse-2" class="collapse show" data-parent="#accordion"
                                            ...
                                            <div class="card-body">
                                                <form id="muted_khotian_add_edit"
                                                      action="{{ route('admin.khotians.batch-entry.store') }}"
                                                      method="POST"
                                                        ...
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    <option value="{{ $locDivision->bbs_code }}" selected>
                                                                        {{ $locDivision->title }}
                                                                    </option>
                                                                </select>
                                                        ...
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    <option value="">নির্বাচন করুণ</option>
                                                                    <option value="{{ $locDistrict->bbs_code }}" selected>
                                                                        {{ $locDistrict->title }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <select
                                                                                                    ...
                                                                                                    {{-- main code @foreach(\Modules\Khotian\App\Models\MutedKhotian::SIGNATURE_DESIGNATION as $key=>$value)
                                                                                                        <option
                                                                                                            value="{{ $key }}">
                                                                                                            {{ $value }}
                                                                                                        </option>
...
@push('js')
    ...
    <script>
        ...
        $('#not_providable').click(function (e) {
            if ($(this).is(':checked')) {
        ...
        $("#muted_khotian_add_edit").validate({
            ...
            messages: {
                ...
                khotian_number: {
                    ...
                    pattern: "এখানে সঠিক খতিয়ান নম্বর দিন।"
                },
                jl_number: {},
                resa_no: {
            ...
            if (districtBbcCode) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        let authUpazilaBbsCode = '{!! !empty($office->upazila_bbs_code)? $office->upazila_bbs_code:null !!}';
            ...
            if (divisionBbcCode) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        let authDistrictBbsCode = '{!! !empty($office->district_bbs_code)?$office->district_bbs_code:null !!}';
