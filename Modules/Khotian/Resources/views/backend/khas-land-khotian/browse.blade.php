                ...
                <div class="card">
                    <div class="card-header custom-header-bg">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.khotians.khasland-khotian') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning pull-right"
                            data-dismiss="modal">{{ __('generic.cancel') }}</button>
                    <form action="{{route('admin.khotians.khotian-approve-all')}}" id="approve-now-form" class="float-left"
                          method="post">
                        {{ method_field("PUT") }}
                        {{ csrf_field() }}
    ...
    <script>
        $(function () {
            ...
            let params = serverSideDatatableFactory({
                url: '{{route('admin.khotians.khasland-khotians.datatable')}}',
                order: [[0, "asc"]],
                language: {
                    "url": lanBnPath,
                },
                ...
                columnDefs: [
                    {
                        ...
                        "createdCell": function (td, cellData, rowData, row, col) {
                            let rowStatus = '{!! \App\Models\BaseModel::STATUS_ACTIVE !!}';
