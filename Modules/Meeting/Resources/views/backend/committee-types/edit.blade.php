        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="edit-add-form" method="post"
                      action="{{ route('admin.meeting_management.committee-types.update', $committeeType) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control custom-form-control"
                                       name="title"
                                       id="title" value="{{ $committeeType->title }}"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control custom-form-control"
                                       name="title_en"
                                       id="title_en" value="{{ $committeeType->title_en }}"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control custom-form-control"
                                    ...
                                    @foreach(\Modules\Meeting\Models\committeeType::OFFICE_TYPE as $key=>$value)
                                        <option
                                            value="{{ $key }}" {{ $edit && $committeeType->office_type == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
