                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading-2" style="background: #8dc542">
                                            <p class="mb-0 text-white">
                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> খতিয়ান সংশোধন
                                        ...
                                        <div id="collapse-2" class="collapse show" data-parent="#accordion"
                                            ...
                                            <div class="card-body">
                                                <form id="muted_khotian_add_edit"
                                                      action="{{ route('admin.khotians.entry.update', $mutedKhotian->id ) }}"
                                                      method="POST"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="dhara_year"
                                                                       {{  $mutedKhotianInfoData['has_dhara']?'':'disabled'  }}
                                                                       value="{{  en2bn($mutedKhotianInfoData['dhara_year']??'')  }}"
                                                                       id="dhara_year">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                        ...
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="revenue"
                                                                       value="{{ en2bn($mutedKhotianInfoData['revenue']??'') }}"
                                                                       id="revenue">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                                                        ...
                                                                                        <div class="col-md-3 m-0">
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    id="owner_no"
                                                                                                    name="owner_no"
                                                                                                    value="{{ !empty($mutedKhotianOwnersInfo)? en2bn(count($mutedKhotianOwnersInfo)+1) :en2bn(1) }}"
                                                                                                    readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    @foreach($mutedKhotianOwnersInfo as $key=>$value)
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="vertical-align: middle;"
                                                                                                class="sno">
                                                                                                <span
                                                                                                    id="tbl_view_owner_no{{ $key+1 }}"> {{ en2bn($value['owner_no']) }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
...
@push('javascript')
    ...
    <script>
        ...
        $('#user_check_submit').on('click', function (e) {
            ...
            showLoader();
            $.ajax({
                url: "{{route('get-owners-info-from-nid-api')}}",
                data: {
                    nid: nidNo,
