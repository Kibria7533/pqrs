<div class="modal-header custom-bg-gradient-info">
    <h4 class="modal-title">
        <i class="fas fa-eye"></i> {{ __('generic.view_district') }}
    </h4>
            ...
            <div class="card bg-white">
                <div class="card-body row">
                    ...
                    <div class="col-md-6 custom-view-box">
                        ...
                        <div class="input-box">
                            {{ $locDistrict->has_khatian ?__('generic.yes') : __('generic.no') }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 custom-view-box">
                        ...
                        <div class="input-box">
                            {{ $locDistrict->has_map ? __('generic.yes') : __('generic.no') }}
                        </div>
                    </div>
