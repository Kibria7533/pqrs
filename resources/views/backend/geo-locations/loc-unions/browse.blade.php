    ...
    <script>
        $(function () {
            ...
            let params = serverSideDatatableFactory({
                url: '{{route('admin.loc-unions.datatable')}}',
                order: [[2, "asc"]],
                language: {
                    "url": lanBnPath,
                },
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        data: "loc_upazilas.title",
                        name: "loc_upazilas.title"
                    },
                    {
            ...
            if ($(".create-new-button").length) {
                $(document).on('click', ".create-new-button", async function () {
                    let url = '{{route('admin.loc-unions.create')}}';
            ...
            $(document).on('change', '#loc_division_id', function(e) {
                $("#loc_district_id").val('').trigger('change');
                $("#loc_upazila_id").val('').trigger('change');
            });

            $(document).on('change', '#loc_district_id', function(e) {
                $("#loc_upazila_id").val('').trigger('change');
            });
