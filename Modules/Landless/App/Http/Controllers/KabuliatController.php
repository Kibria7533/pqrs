...
use Modules\Landless\App\Services\KabuliatService;

class KabuliatController extends BaseController
{
    protected KabuliatService $kabuliatService;
    private const VIEW_PATH = 'landless::backend.kabuliats.';

    public function __construct(KabuliatService $kabuliatService)
    {
        $this->kabuliatService = $kabuliatService;
        $this->authorizeResource(Kabuliat::class);
    }
