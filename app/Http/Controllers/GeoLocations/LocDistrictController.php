...
class LocDistrictController extends BaseController
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json(['message' => __('generic.object_created_successfully', ['object' => __('generic.district')]), 'alert-type' => 'success']);
    ...
    public function update(Request $request, LocDistrict $locDistrict)
    {
        ...
        return response()->json(['message' => __('generic.object_updated_successfully', ['object' => __('generic.district')]), 'alert-type' => 'success']);
    }
    ...
    public function validator(Request $request): Validator
    {
        return \Illuminate\Support\Facades\Validator::make($request->all(), [
            ...
            'dglr_code' => 'required|string',
            'loc_division_id'=> 'required|exists:loc_divisions,id',
            'has_map'=> 'required|boolean',
            'has_khatian'=> 'required|boolean',
            'status'=> 'nullable',
            'created_by' => 'nullable',
            'updated_by' => 'nullable'
        ]);
    ...
    public function getDatatable(Request $request): JsonResponse
    {
        ...
        /** relations */
        $locDistricts->join('loc_divisions', 'loc_districts.loc_division_id', '=', 'loc_divisions.id')->orderBy('loc_districts.id', 'DESC');
