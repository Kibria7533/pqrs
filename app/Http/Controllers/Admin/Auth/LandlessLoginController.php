...
class LandlessLoginController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = '/landless-portal';
    protected $currentGuardName = 'landless';
    ...
    {
        $this->middleware('guest:landless', ['except' => ['logout', 'showLoginForm']]);
    }
    ...
    public function showLoginForm()
    {
        if(Auth::guard('landless')->check()){
            return redirect()->route('landless.dashboard');
        }
        return view('master::landless-portal.auth.landless-login');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('landless')->attempt(['email' => $request->email, 'password' => $request->password])) {
            // if successful, then redirect to their intended location
            return redirect()->intended(route('landless.dashboard'));
        }
