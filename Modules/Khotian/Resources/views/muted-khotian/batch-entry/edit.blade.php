                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="accordion">
                                    <div class="card">
                                        <div class="card-header custom-header-bg" id="heading-2" style="height: 56px">
                                            <h3 class="card-title font-weight-bold">
                                                <i class="fas fa-edit"></i> খতিয়ান সংশোধন
                                            </h3>
                                        ...
                                        <div id="collapse-2" class="collapse show" data-parent="#accordion"
                                            ...
                                            <div class="card-body">
                                                <form id="muted_khotian_add_edit"
                                                      action="{{ route('admin.khotians.batch-entry.update', $mutedKhotian->id ) }}"
                                                      method="POST"
...
<!--                                                        <div class="col-md-3 m-0">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    @foreach($locDivisions as $locDivision)
                                                                        <option
                                                                            value="{{ $locDivision->bbs_code }}" {{ $locDivision->bbs_code ==  $office->division_bbs_code ? 'selected':'' }}>{{ $locDivision->title }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="resa_no"
                                                                       value="{{ $mutedKhotianInfoData['resa_no']??'' }}"
                                                                       id="resa_no">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       ...
                                                                       value="{{ $mutedKhotianInfoData['namjari_case_no']??'' }}"
                                                                       id="namjari_case_no">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control datepicker"
                                                                       ...
                                                                       value="{{ $mutedKhotianInfoData['case_date']??'' }}"
                                                                       id="case_date">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            name="has_dhara"
                                                                            id="has_dhara_yes"
                                                                            {{  $mutedKhotianInfoData['has_dhara']?'checked':''  }}
                                                                            value="1">
                                                                        <label
                                                        ...
                                                        <div
                                                            class="col-md-3 m-0 {{  $mutedKhotianInfoData['has_dhara']?'':'d-none'  }}"
                                                            id="dhara_no_area">
                                                            <div class="form-group">
                                                                <label for="dhara_no">
                                                                    ধারা নং
                                                                ...
                                                                <input class="form-control"
                                                                       name="dhara_no"
                                                                       {{  $mutedKhotianInfoData['has_dhara']?'':'disabled'  }}
                                                                       value="{{  $mutedKhotianInfoData['dhara_no']??''  }}"
                                                                       id="dhara_no">
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="dhara_year"
                                                                       {{  $mutedKhotianInfoData['has_dhara']?'':'disabled'  }}
                                                                       value="{{ \App\Helpers\Classes\NumberToBanglaWord::engToBn($mutedKhotianInfoData['dhara_year']??'')   }}"
                                                                       id="dhara_year">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="mokoddoma_no"
                                                                       value="{{  $mutedKhotianInfoData['mokoddoma_no']??'' }}"
                                                                       id="mokoddoma_no">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="revenue"
                                                                       value="{{ \App\Helpers\Classes\NumberToBanglaWord::engToBn($mutedKhotianInfoData['revenue']??'') }}"
                                                                       id="revenue">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 m-0">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="dcr_number"
                                                                       value="{{ $mutedKhotianInfoData['dcr_number']??'' }}"
                                                                       id="dcr_number">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                        ...
                                                                        <div class="row border p-2 rounded">
                                                                                        ...
                                                                                        <div class="col-md-3 m-0">
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    id="owner_sl_no"
                                                                                                    name="owner_sl_no"
                                                                                                    value="{{ !empty($mutedKhotianOwnersInfo)? count($mutedKhotianOwnersInfo)+1 :'' }}"
                                                                                                    disabled>
                                                                                                <label for="owner_no">
                                                                                                    মালিক নং</label>
                                                                                                <input
                                                                                                    ...
                                                                                                    id="owner_no"
                                                                                                    name="owner_no"
                                                                                                    value="{{ !empty($mutedKhotianOwnersInfo)? \App\Helpers\Classes\NumberToBanglaWord::engToBn(count($mutedKhotianOwnersInfo)+1) :\App\Helpers\Classes\NumberToBanglaWord::engToBn(1) }}"
                                                                                                    readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-9 m-0">
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    @foreach(\Modules\Khotian\App\Models\MutedKhotian::OWNER_IDENTITY_TYPE as $key=>$value)
                                                                                                        <div
                                                                                                            class="form-check form-check-inline">
                                                                                                            <input
                                                                                                                ...
                                                                                                                type="radio"
                                                                                                                name="identity_type"
                                                                                                                id="identity_type_{{ !empty($key)? \Modules\Khotian\App\Models\MutedKhotian::IDENTITY_TYPE[$key]:'' }}"
                                                                                                                value="{{ $key }}"
                                                                                                                {{ !empty($key)? (\Modules\Khotian\App\Models\MutedKhotian::IDENTITY_TYPE[$key]==='nid'?'checked':''):'' }}>
                                                                                                            <label
                                                                                                                class="form-check-label"
                                                                                                                for="identity_type_{{ !empty($key)? \Modules\Khotian\App\Models\MutedKhotian::IDENTITY_TYPE[$key]:'' }}">
                                                                                                                {{ $value }}
                                                                                                            </label>
                                                                                                        </div>
                                                                                                    @endforeach
                                                                            ...
                                                                            <div class="col-md-6 m-0"
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    @foreach($mutedKhotianOwnersInfo as $key=>$value)
                                                                                        <tr>
                                                                                            <input type="hidden"
                                                                                                   name="owners[owner_id][{{ $key+1 }}]"
                                                                                                   value="{{ $value['id'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_no{{ $key+1 }}"
                                                                                                   name="owners[owner_no][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_no'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_name{{ $key+1 }}"
                                                                                                   name="owners[owner_name][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_name'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_guardian_type{{ $key+1 }}"
                                                                                                   name="owners[guardian_type][{{ $key+1 }}]"
                                                                                                   value="{{ $value['guardian_type'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_guardian{{ $key+1 }}"
                                                                                                   name="owners[guardian][{{ $key+1 }}]"
                                                                                                   value="{{ $value['guardian'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_mother_name{{ $key+1 }}"
                                                                                                   name="owners[mother_name][{{ $key+1 }}]"
                                                                                                   value="{{ $value['mother_name'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_area{{ $key+1 }}"
                                                                                                   name="owners[owner_area][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_area'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_group{{ $key+1 }}"
                                                                                                   name="owners[owner_group][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_group'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_mobile{{ $key+1 }}"
                                                                                                   name="owners[owner_mobile][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_mobile'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_identity_type{{ $key+1 }}"
                                                                                                   name="owners[identity_type][{{ $key+1 }}]"
                                                                                                   value="{{ $value['identity_type'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_identity_number{{ $key+1 }}"
                                                                                                   name="owners[identity_number][{{ $key+1 }}]"
                                                                                                   value="{{ $value['identity_number'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_dob{{ $key+1 }}"
                                                                                                   name="owners[dob][{{ $key+1 }}]"
                                                                                                   value="{{ $value['dob'] }}">
                                                                                            <input type="hidden"
                                                                                                   id="tbl_owner_address{{ $key+1 }}"
                                                                                                   name="owners[owner_address][{{ $key+1 }}]"
                                                                                                   value="{{ $value['owner_address'] }}">
                                                                                            <td style="vertical-align: middle;"
                                                                                                class="sno">
                                                                                                <span
                                                                                                    id="tbl_view_owner_no{{ $key+1 }}"> {{ \App\Helpers\Classes\NumberToBanglaWord::engToBn($value['owner_no']) }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_owner_name{{ $key+1 }}"> {{ $value['owner_name'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_guardian{{ $key+1 }}"> {{ $value['guardian'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_mother_name{{ $key+1 }}"> {{ $value['mother_name'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_owner_area{{ $key+1 }}"> {{ $value['owner_area'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_dob{{ $key+1 }}"> {{ $value['dob'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <div class="btn-group"
                                                                                                     role="group"
                                                                                                    ...
                                                                                                    <button
                                                                                                        type="button"
                                                                                                        class="btn btn-outline-info btn-group-sm"
                                                                                                        onclick="ownerEdit({{ $key+1 }})"
                                                                                                        id="owner-edit-{{ $key+1 }}">
                                                                                                        সম্পাদন
                                                                                                    </button>
                                                                                                    <button
                                                                                                        type="button"
                                                                                                        class="btn btn-outline-warning btn-group-sm"
                                                                                                        onclick="ownerDelete({{ $key+1 }})"
                                                                                                        id="owner-delete{{ $key+1 }}">
                                                                                                        মুছুন
                                                                                                    </button>
                                                                                                </div>
                                                                                            </td>
                                                                        ...
                                                                        <div class="row border p-2 rounded">
                                                                                            ...
                                                                                            <div class="col-md-6 m-0">
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        ...
                                                                                                        id="dag_sl_no"
                                                                                                        name="dag_sl_no"
                                                                                                        value="{{ !empty($mutedKhotianDagsInfo)? count($mutedKhotianDagsInfo):'' }}"
                                                                                                        disabled>
                                                                                                    <input
                                                                                                        class="form-control"
                                                                                                        name="dag_number"
                                                                                            ...
                                                                                            <div class="col-md-6 m-0">
                                                                                                <div
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        @foreach(\Modules\Khotian\App\Models\MutedKhotian::OWNER_TYPE as $key=>$value)
                                                                                                            <option
                                                                                                                value="{{ $key }}">
                                                                                                                {{ $value }}
                                                                                                            </option>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <select
                                                                                                                ...
                                                                                                                @foreach(\Modules\Khotian\App\Models\MutedKhotian::LAND_TYPE as $key=>$value)
                                                                                                                    <option
                                                                                                                        value="{{ $key }}">
                                                                                                                        {{ $value }}
                                                                                                                    </option>
                                                                            ...
                                                                            <div class="col-md-6 m-0"
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    @foreach($mutedKhotianDagsInfo as $key=>$value)
                                                                                        <tr>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <input type="hidden"
                                                                                                       name="dags[dag_id][{{ $key+1 }}]"
                                                                                                       value="{{ $value['id'] }}">
                                                                                                <input type="hidden"
                                                                                                       id="tbl_dag_number{{ $key+1 }}"
                                                                                                       name="dags[dag_number][{{ $key+1 }}]"
                                                                                                       value="{{ $value['dag_number'] }}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_land_owner_type_id{{ $key+1 }}"
                                                                                                    name="dags[land_owner_type_id][{{ $key+1 }}]"
                                                                                                    value="{{$value['land_owner_type_id']}}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_agricultural_use{{ $key+1 }}"
                                                                                                    name="dags[agricultural_use][{{ $key+1 }}]"
                                                                                                    value="{{$value['agricultural_use']}}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_agri_land_type{{ $key+1 }}"
                                                                                                    name="dags[agri_land_type][{{ $key+1 }}]"
                                                                                                    value="{{ $value['agricultural_use']? $value['land_type_id']:'' }}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_non_agri_land_type{{ $key+1 }}"
                                                                                                    name="dags[non_agri_land_type][{{ $key+1 }}]"
                                                                                                    value="{{ $value['agricultural_use']? '':$value['land_type_id'] }}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_total_dag_area{{ $key+1 }}"
                                                                                                    name="dags[total_dag_area][{{ $key+1 }}]"
                                                                                                    value="{{$value['total_dag_area']}}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_khotian_dag_portion{{ $key+1 }}"
                                                                                                    name="dags[khotian_dag_portion][{{ $key+1 }}]"
                                                                                                    value="{{$value['khotian_dag_portion']}}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_khotian_dag_area{{ $key+1 }}"
                                                                                                    name="dags[khotian_dag_area][{{ $key+1 }}]"
                                                                                                    value="{{$value['khotian_dag_area']}}">
                                                                                                <input
                                                                                                    type="hidden"
                                                                                                    id="tbl_remarks{{ $key+1 }}"
                                                                                                    name="dags[remarks][{{ $key+1 }}]"
                                                                                                    value="{{ $value['remark'] }}">
                                                                                                <span
                                                                                                    id="tbl_view_dag_number{{ $key+1 }}"> {{ $value['dag_number'] }} </span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_agricultural_use{{ $key+1 }}">{{ $value['agricultural_use']?'কৃষি':'অকৃষি' }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_total_dag_area{{ $key+1 }}"> {{ $value['total_dag_area'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_khotian_dag_area{{ $key+1 }}"> {{ $value['khotian_dag_area'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_khotian_dag_portion{{ $key+1 }}"> {{ $value['khotian_dag_portion'] }}</span>
                                                                                            </td>

                                                                                            <td style="vertical-align: middle;">
                                                                                                <span
                                                                                                    id="tbl_view_remarks{{ $key+1 }}"> {{ $value['remark'] }}</span>
                                                                                            </td>
                                                                                            <td style="vertical-align: middle;">
                                                                                                <div class="btn-group"
                                                                                                     role="group"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_one_name:'' }}"
                                                                                                    placeholder="নাম">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    autocomplete="off"
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_one_date:'' }}"
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach(\Modules\Khotian\App\Models\MutedKhotian::SIGNATURE_DESIGNATION as $key=>$value)
                                                                                                        <option
                                                                                                            value="{{ $key }}" {{ !empty($mutedKhotian)? ($mutedKhotian->signature_one_designation == $key? 'selected':'' ):'' }}>
                                                                                                            {{ $value }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_two_name:'' }}"
                                                                                                    placeholder="নাম">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    autocomplete="off"
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_two_date:'' }}"
                                                                                                    placeholder="স্বাক্ষরের তারিখ (দিন-মাস-বছর)">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach(\Modules\Khotian\App\Models\MutedKhotian::SIGNATURE_DESIGNATION as $key=>$value)
                                                                                                        <option
                                                                                                            value="{{ $key }}" {{ !empty($mutedKhotian)? ($mutedKhotian->signature_two_designation == $key? 'selected':'' ):'' }}>
                                                                                                            {{ $value }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_three_name:'' }}"
                                                                                                    placeholder="নাম">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <input
                                                                                                    ...
                                                                                                    autocomplete="off"
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->signature_three_date:'' }}"
                                                                                                    placeholder="স্বাক্ষরের তারিখ (দিন-মাস-বছর)">
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach(\Modules\Khotian\App\Models\MutedKhotian::SIGNATURE_DESIGNATION as $key=>$value)
                                                                                                        <option
                                                                                                            value="{{ $key }}" {{ !empty($mutedKhotian)? ($mutedKhotian->signature_three_designation == $key? 'selected':'' ):'' }}>
                                                                                                            {{ $value }}
                                                                                                        </option>
                                                                                                    @endforeach --}}
                                                                                                    <option value="4"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="checkbox"
                                                                                                   name="not_providable"
                                                                                                   id="not_providable"
                                                                                                   value="1" {{ !empty($mutedKhotian->not_providable)? 'checked':'' }} />
                                                                                            এই খতিয়ানটি প্রদানযোগ্য নয়
                                                                                        </label>
                                                                                        ...
                                                                                        <div class="col-md-10"
                                                                                            ...
                                                                                            <select name="reasons[]"
                                                                                                ...
                                                                                                @foreach(\Modules\Khotian\App\Models\MutedKhotian::NON_PROVIDABLE_REASONS as $key=>$value)
                                                                                                    <option
                                                                                                        value="{{ $key }}" {{ !empty($mutedKhotian->reasons) && in_array($key, json_decode($mutedKhotian->reasons) )?'selected':'' }}> {{ $value }} </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        ...
                                                                                        <div class="col-md-6 m-0">
                                                                                            <div
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    value="{{ !empty($mutedKhotian)?$mutedKhotian->agoto_khotian_no:'' }}"
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach(\App\Models\KhotianIndexs::SURVEY_TYPE as $key=>$value)
                                                                                                        <option
                                                                                                            value="{{ $key }}" {{ !empty($mutedKhotian)? ($mutedKhotian->agoto_khotian_type == $key? 'selected':'' ):'' }}>
                                                                                                            {{ $value }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                <label for=""
                                                                                                       class="d-block">
                                                                                                    <span>খতিয়ানের স্ক্যান কপি <spam
                                                                                                            class="text-danger">*</spam></span>
                                                                                                    <!-- Button trigger modal -->
                                                                                                    @if(!empty($mutedKhotian->scan_copy))
                                                                                                        @if(pathinfo( !empty($mutedKhotian->scan_copy)? $mutedKhotian->scan_copy : '', PATHINFO_EXTENSION) === 'pdf')
                                                                                                            <a
                                                                                                                target="_blank"
                                                                                                                href="{{ asset("storage/{$mutedKhotian->scan_copy}") }}"
                                                                ...
                                                                <div class="col-md-12 m-0">
                                                                    <div class="float-right"
                                                                         role="group"
                                                                         aria-label="Basic example">
                                                                        <button type="submit" name="next_stage"
                                                                                value="false"
                                                                                class="btn btn-success">
                                                                        ...
                                                                        <button type="submit"
                                                                                class="btn btn-info" name="next_stage"
                                                                                value="true">
                                                                            পরবর্তীধাপে প্রেরণ করুন &nbsp;
                                                                            <i class="fa fa-check-circle"
                                                                               aria-hidden="true"></i>
                                                                        </button>
                                                                    </div>
    ...
    <!-- Modal for previous khotian view -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scan_file_viewerTitle">খতিয়ানের স্ক্যান কপি</h5>
                ...
                <div class="modal-body">
                    @if(pathinfo( !empty($mutedKhotian->scan_copy)? $mutedKhotian->scan_copy : '', PATHINFO_EXTENSION) === 'pdf')
                        <iframe src="{{ asset("storage/{$mutedKhotian->scan_copy}") }}" frameborder="0" height="100%"
                                width="100%">
                        </iframe>
                    @else
                        <img
                            src="{{ !empty($mutedKhotian->scan_copy)? asset("storage/{$mutedKhotian->scan_copy}"):'' }}"
                            alt="Flowers in Chania" width="100%" height="345">
                    @endif
                </div>
            </div>
        </div>
...
@push('js')
    ...
    <script>
        ...
        let notProvidable = '{{ !empty($mutedKhotian->not_providable) }}';
        ...
        let countOwner = {{ !empty($mutedKhotianOwnersInfo)? count($mutedKhotianOwnersInfo):0 }};
        let hasOwner = {{ !empty($mutedKhotianOwnersInfo)? count($mutedKhotianOwnersInfo):0 }};
        let hasDag = {{ !empty($mutedKhotianDagsInfo)? count($mutedKhotianDagsInfo):0 }};
        let ownerAreaCount = {{ !empty($ownerAreaCount)?$ownerAreaCount:0 }};
        let alreadyAddedOwnerIdentityNo = <?= !empty($onewsIdentityNumbers) ? json_encode($onewsIdentityNumbers) : '[]'?>;
        let countDag = {{ !empty($mutedKhotianDagsInfo)? count($mutedKhotianDagsInfo):0 }};
        let dagNoCount = <?= !empty($dagNoCount) ? json_encode($dagNoCount) : '[]'?>;
        let apiNID = null;
        let apiName = null;
        let apiDOB = null;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (key, value) {
                            ...
                            let jlNumber = '{!! $mutedKhotianInfoData['jl_number'] !!}'
                            $('#loc_all_mouja_id').append(
                                '<option value="' + key + '" data-dglr-code="' + key + '" '+(key==jlNumber?'selected':'')+' >' + value + '</option>'
                            );
                        });
                        //hideLoader();
                    },
            ...
            if (districtBbcCode) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        let authUpazilaBbsCode = '{!! $office->upazila_bbs_code !!}';

                        if (authUpazilaBbsCode) {
                            $.each(response, function (key, value) {
                                if (authUpazilaBbsCode == value.bbs_code) {
                                    $('#upazila_bbs_code').append(
                                        '<option value="' + value.bbs_code + '" selected>' + value.title + '</option>'
                                    );
                                }
                            });
                        } else {
            ...
            if (divisionBbcCode) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        let authDistrictBbsCode = '{!! $office->district_bbs_code !!}';

                        if (authDistrictBbsCode) {
                            $.each(response, function (key, value) {
                                if (authDistrictBbsCode == value.bbs_code) {
        ...
        $('#loc_all_mouja_id').on('change', function () {
            $('#jl_number').val($(this).val());
        });

        if ($('#division_bbs_code').val() != '') {
            loadDistricts();
        }
        ...
        $(document).on("keypress", "#khotian_number", function (event) {
            let txt = $(this).attr('id');
            if (event.key === 'Enter') {
                return false;
            }
        ...
        if ({{ !empty($mutedKhotianOwnersInfo) && count($mutedKhotianOwnersInfo)>0?1:0 }}) {
            ownerFieldDisable();
        }
        if ({{ !empty($dagNoCount) && count($dagNoCount)>0 ?1:0 }}) {
            dagEntryFieldsDisable();
        }
