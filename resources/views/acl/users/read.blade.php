    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex justify-content-between custom-bg-gradient-info">
                <h3 class="card-title font-weight-bold text-primary">{{__('generic.user')}}</h3>
                    ...
                    <div class="user-contact card bg-white mb-3">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <p class="medium-text ml-2 text-primary">{{ __('email') }}</p>
                            </div>
                            <div class="email">
                ...
                <div class="col-md-8">
                    <div class="card bg-white">
                        <div class="card-header custom-bg-gradient-info text-primary">
                            <h3 class="card-title font-weight-bold">{{ __('generic.user_info') }}</h3>
                        </div>
                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-6 custom-view-box">
                                <p class="label-text">{{ __('generic.user_type') }}</p>
                                <div class="input-box">
                                    {{ $user->UserType->title ?? "" }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 custom-view-box">
                                <p class="label-text">{{ __('generic.office') }}</p>
                                <div class="input-box">
                                    {{ $user->office->name_bn ?? "" }}
                                </div>
                            </div>
