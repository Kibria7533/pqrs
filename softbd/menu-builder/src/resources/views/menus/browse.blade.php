        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3 class="card-title font-weight-bold">{{ __('generic.menu_list') }}</h3>
                    ...
                    <div class="btn-group">
                        ...
                        <a href="#" class="btn btn-sm btn-outline-success export">
                            <i class="fas fa-file-export"></i> {{ __('generic.menu_export') }}
                        </a>

                        <a href="#" class="btn btn-sm btn-outline-danger import">
                            <i class="fas fa-file-import"></i> {{ __('generic.menu_import') }}
                        </a>
                    </div>
                </div>
                <!-- /.card-header -->
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{route('menu-builder.menus.builder', $menu->id)}}"
                                           class="btn btn-sm btn-outline-success">
                                            <i class="fas fa-building"></i>  {{ __('generic.menu_builder') }}
                                        </a>
                                        ...
                                        <a href="#" data-action="{{route('menu-builder.menus.destroy', $menu->id)}}"
                                           class="btn btn-sm delete btn-outline-danger">
                                            <i class="fas fa-trash"></i> {{ __('generic.delete_button_label') }}
                                        </a>
                                    </div>
                                </td>
                            </tr>
